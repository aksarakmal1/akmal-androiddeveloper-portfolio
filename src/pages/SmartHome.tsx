...
import { ArrowLeft, ExternalLink, Github, Home, Zap, Settings, Wifi } from 'lucide-react';
import { Link } from 'react-router-dom';

const SmartHome: React.FC = () => {
  const screenshots = [
    {
      url: "https://images.pexels.com/photos/3988335/pexels-photo-3988335.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      title: "Device Control"
    },
    {
      url: "https://images.pexels.com/photos/3988336/pexels-photo-3988336.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      title: "Energy Analytics"
    },
    {
      url: "https://images.pexels.com/photos/3988337/pexels-photo-3988337.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      title: "Automation Rules"
    },
    {
      url: "https://images.pexels.com/photos/3988338/pexels-photo-3988338.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      title: "Scene Control"
    }
  ];
  ...
  const features = [
    {
      ...
      description: "Control all your smart home devices from a single interface"
    },
    {
    ...
    },
    {
      ...
      description: "Create custom rules and schedules for your devices"
    },
    {
          ...
          >
            <div>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
                A comprehensive smart home control center that lets you manage all your IoT devices, set up automations, and monitor energy usage from a single intuitive interface.
              </p>
              ...
              <div className="relative w-[280px] h-[560px] mx-auto">
                <div className="absolute inset-0 bg-gradient-to-tr from-primary-600 to-primary-400 rounded-[3rem] p-3 shadow-2xl">
                  <div className="absolute inset-0 bg-gray-900 rounded-[2.5rem] overflow-hidden">
                    <img 
                      src="https://images.pexels.com/photos/3988335/pexels-photo-3988335.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                      alt="SmartHome App Main Screen"
            ...
            <div className="lg:col-span-2">
              ...
              <div className="prose dark:prose-invert max-w-none">
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  SmartHome Control is built using modern Android development practices and IoT protocols to ensure reliable device control and automation capabilities.
                </p>
                ...
                <ul className="space-y-4 text-gray-600 dark:text-gray-300">
                  <li>
                    <strong>Architecture:</strong> Clean Architecture with MVVM pattern for maintainable and testable code
                  </li>
                  <li>
                    <strong>UI Framework:</strong> Jetpack Compose with Material You design system for modern, native Android UI
                  </li>
                  <li>
                    <strong>IoT Protocols:</strong> MQTT, Zigbee, and Z-Wave protocol integration for wide device support
                  </li>
                  <li>
                    <strong>Real-time Updates:</strong> WebSocket connections for instant device state updates
                  </li>
                  <li>
                    <strong>Local Storage:</strong> Room database for caching device states and user preferences
                  </li>
                </ul>
              </div>
            </div>
